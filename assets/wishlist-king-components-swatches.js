...
import { WishlistElement } from "https://cdn.jsdelivr.net/npm/@appmate/wishlist@4.20.5/wishlist-element.js";
import { ProductFormController } from "https://cdn.jsdelivr.net/npm/@appmate/wishlist@4.20.5/controllers.js";
import { Icon } from "https://cdn.jsdelivr.net/npm/@appmate/wishlist@4.20.5/components/icon.js";
import "https://cdn.jsdelivr.net/npm/@appmate/wishlist@4.20.5/components/button.js";
import "https://cdn.jsdelivr.net/npm/@appmate/wishlist@4.20.5/components/option-select.js";
import "https://cdn.jsdelivr.net/npm/@appmate/wishlist@4.20.5/components/option-swatches.js";
...
export class WishlistProductCard extends WishlistElement {
  ...
  renderProductOptions() {
    ...
    return html`
      ${this.form.optionsWithValues.map((option) => {
        if (option.name === "Farbwunsch") {
          return html`
            <wk-option-swatches
